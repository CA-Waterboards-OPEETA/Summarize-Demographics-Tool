...
with arcpy.da.SearchCursor(analysis_boundaries, fields) as cursor:
  for i, row in zip(range(1,iterations), cursor):
    ...
    #selection of resulting union feature that has GEOID_block value, cuz union is including parts that don't have centroids within boundary layer
...
"English_Only_Perc", "Spanish_Perc", "French_Haitian_Cajun_Perc", "German_WestGermanic_Perc", "Russian_Polish_Slavic_Perc", "OtherIndoEuro_Perc","Korean_Perc", "Chinese_Perc", "Vietnamese_Perc", "Tagalog_incl_Filipino_Perc", "OtherAsianPacIsl_Perc", "Arabic_Perc", "OtherLang_Perc"]
